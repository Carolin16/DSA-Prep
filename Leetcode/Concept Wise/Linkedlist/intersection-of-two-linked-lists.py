"""
Q 160 https://leetcode.com/problems/intersection-of-two-linked-lists/
...
this algorithm only traverses each list once. This is because the pointers are already "lined up" from the start, so the additional pass is unnecessary.
